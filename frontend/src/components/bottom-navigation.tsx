...
export default function BottomNavigation() {
  ...
  return (
    <div className="fixed bottom-0 z-50 w-full max-w-2xl min-w-xs bg-white">
      <div className="flex justify-around items-center h-15">
        ...
        <Link href="/price" className="flex flex-col items-center">
          ...
          <span className={`text-base font-medium ${pathname === '/price' ? 'text-black' : 'text-gray-600'}`}>시세 조회</span>
        </Link>
        <Link href="/register" className="flex flex-col items-center">
          ...
          <span className={`text-base font-medium ${pathname === '/register' ? 'text-black' : 'text-gray-600'}`}>차량 등록</span>
        </Link>
        <Link href="/mycar" className="flex flex-col items-center">
          ...
          <span className={`text-base font-medium ${pathname === '/mycar' ? 'text-black' : 'text-gray-600'}`}>내 차량</span>
        </Link>
      </div>
    </div>
  )
